...
goog.exportSymbol('proto.ObjectEnterSyncResp', null, global);
 ...
 * @constructor
 */
proto.ObjectEnterSyncResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ObjectEnterSyncResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.ObjectEnterSyncResp.displayName = 'proto.ObjectEnterSyncResp';
}
 ...
 * @return {!Object}
 */
proto.ObjectEnterSyncResp.prototype.toObject = function(opt_includeInstance) {
  return proto.ObjectEnterSyncResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ObjectEnterSyncResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ObjectEnterSyncResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    objectInfo: (f = msg.getObjectInfo()) && proto.ObjectInfo.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ObjectEnterSyncResp}
 */
proto.ObjectEnterSyncResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ObjectEnterSyncResp;
  return proto.ObjectEnterSyncResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ObjectEnterSyncResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ObjectEnterSyncResp}
 */
proto.ObjectEnterSyncResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ObjectEnterSyncResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ObjectEnterSyncResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ObjectEnterSyncResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ObjectEnterSyncResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getObjectInfo();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
 ...
 */
proto.ObjectEnterSyncResp.prototype.getObjectInfo = function() {
  return /** @type{?proto.ObjectInfo} */ (
    jspb.Message.getWrapperField(this, proto.ObjectInfo, 1));
};


/** @param {?proto.ObjectInfo|undefined} value */
proto.ObjectEnterSyncResp.prototype.setObjectInfo = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.ObjectEnterSyncResp.prototype.clearObjectInfo = function() {
  this.setObjectInfo(undefined);
};
 ...
 * @return {!boolean}
 */
proto.ObjectEnterSyncResp.prototype.hasObjectInfo = function() {
  return jspb.Message.getField(this, 1) != null;
};
